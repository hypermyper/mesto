...
export const overlayEditProfile = document.querySelector('.overlay_edit-profile');
export const formEditProfile = document.querySelector('.form_edit-profile');
export const buttonClosePopupEditProfile = overlayEditProfile.querySelector('.form__close-icon');
...
export const overlayImagePopup = document.querySelector('.overlay_image-popup');
export const imagePopup = document.querySelector('.overlay-figure__image');
export const buttonCloseImagePopup = overlayImagePopup.querySelector('.form__close-icon');
...
export const overlayNewPlace = document.querySelector('.overlay_new-place');
